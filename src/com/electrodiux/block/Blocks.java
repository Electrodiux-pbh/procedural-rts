...
public class Blocks {
        ...
        public static void loadBlocks() {
                ...
                BlockRegister.register("grass_block", Blocks.GRASS_BLOCK).setTexture("grass.png").build();
                ...
                BlockRegister.register("blue_orchid", Blocks.BLUE_ORCHID).setTexture("blue_orchid.png")
                                .setTransparent(true)
                                .build();
                BlockRegister.register("paeonia", Blocks.PAEONIA).setTexture("paeonia.png").setTransparent(true)
                                .build();
        }
}

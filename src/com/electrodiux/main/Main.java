    ...
    public static void main(String[] args) {
        ...
        timer.addHandler(new TimerHandler() {
            ...
            public void update() {
                ...
                float velocity = (Keyboard.isKeyPressed(Keyboard.GLFW_KEY_RIGHT_CONTROL) ? 50 : 20) *
                        timer.getDeltaTime();

                float entityVelocity = (Keyboard.isKeyPressed(Keyboard.GLFW_KEY_RIGHT_CONTROL) ? 30 : 8) *
                        timer.getDeltaTime();
